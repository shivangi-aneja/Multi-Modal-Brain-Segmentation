...
# For labelled data
preprocess_static(org_dir="../data/iSEG",prepro_dir= "../data/iSEG_preprocessed",dataset="labeled", overwrite=True)

# For unlabelled data
preprocess_static(org_dir="../data/iSEG",prepro_dir= "../data/iSEG_preprocessed",dataset="unlabeled", overwrite=True)
