...
flags.DEFINE_string("checkpoint_dir", "checkpoint/3d_unet_normalized_val5/current", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("checkpoint_base", "checkpoint/3d_unet_normalized_val5/epochs", "Directory name to save the checkpoints epochs [checkpoint]")
flags.DEFINE_string("best_checkpoint_dir", "checkpoint/3d_unet_normalized_val5/best", "Directory name to save the best checkpoints [checkpoint]")
flags.DEFINE_string("results_dir", "results/3d_unet_normalized_val5/", "Directory name to save the results [results]")
flags.DEFINE_string("tf_logs", "3d_unet_normalized_val5/", "Directory name to save tensorflow logs")
